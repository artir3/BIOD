...
public class Printing {
    ...
    public StringBuilder szyfrowanie(byte[] is, String haslo) {
        this.haslo = haslo;
        ...
        strBuid.append("D�ugo�� has�a:  " + passSize);
        strBuid.append("\n");
        strBuid.append("D�ugo�� tekstu: " + textSize);
        strBuid.append("\n");
        strBuid.append("\n");
        ...
        obrocTabele();
        printTab(result, dl_y, dl_x, "Tabela po obr�ceniu");
    ...
    private void printPrzestawienie(char[][] tab, int X, int Y, String tytul) {
        ...
        strBuid.append("\n");
        for (int y = 0; y < Y; y++) {
            strBuid.append(String.format("%25s", "Znak wiadomo�ci: "));
            for (int x = 0; x < X; x++) {
                strBuid.append(String.format("%3s ", tab[x][y]));
            }
            strBuid.append("\n");
            strBuid.append(String.format("%25s", "Nr. znaku wiadomo�ci: "));
            for (int x = 0; x < X; x++) {
                strBuid.append(String.format("%3d ", (int) tab[x][y]));
            }
            strBuid.append("\n");
            strBuid.append(String.format("%25s", "Warto�� przesuni�cia: "));
            for (int x = 0; x < X; x++) {
